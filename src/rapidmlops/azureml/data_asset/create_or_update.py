...
if __name__ == "__main__":
    ...
    parser.add_argument("--name", type=str, help="The Data Asset name (optional override).")
    parser.add_argument("--commit_sha", type=str, help="The Git Commit SHA (determines Asset Version).")
    parser.add_argument("--pr_id", type=str, help="The Pull Request ID for lineage.")
    parser.add_argument("--source_branch", type=str, help="The branch name serving as secondary lineage.")
